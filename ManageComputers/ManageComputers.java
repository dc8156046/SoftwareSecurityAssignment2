...
public class ManageComputers {
    // White list of CPU, RAM, Disk, GPU and Screen Size
    ...
    private static String getValidatedInput(Scanner s, Set<?> validValues, String prompt) {
        String input;
        do {
            System.out.print(prompt);
            input = s.nextLine().trim();

            // Check if input is in the valid values String set
    ...
    private static void addComputer(ArrayList<Computer> computers, Scanner s) {
        ...
        computerType = s.nextLine().trim().toLowerCase(); // Convert to lower case for comparison purposes
    ...
    private static Computer getComputerData(Scanner s) {
        ...
        int RAM = Integer.parseInt(getValidatedInput(s, VALID_RAM, "Enter RAM (16 or 32): "));
        int disk = Integer.parseInt(getValidatedInput(s, VALID_DISK, "Enter disk (512 or 1024): "));
